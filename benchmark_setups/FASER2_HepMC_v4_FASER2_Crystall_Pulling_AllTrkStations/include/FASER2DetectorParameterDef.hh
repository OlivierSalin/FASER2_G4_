...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/include/FASER2DetectorParameterDef.hh
/// \brief Definition of the FASER2DetectorParameterDef class
//
//
...
// Crystal Puller magnet

G4double fCPMagnetInnerR;
G4double fCPMagnetOuterR;
G4double fCPMagnetLengthZ;
G4int fNCPMagnets;
G4double fCPMagnetGap;
G4double fCPMagnetSpacing;
G4double fCPMagnetZpos;
